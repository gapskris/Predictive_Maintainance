...
Air_Temperature = st.number_input('Air_Temperature', min_value=2.0, max_value=400.0, value=10.0, step=5.0, format="%.2f") 
st.write("Air_Temperature:", f"{Air_Temperature:.2f}")

Process_Temperature = st.number_input('Process_Temperature', min_value=2.0, max_value=400.0, value=10.0, step=5.0, format="%.2f") 
st.write("Process_Temperature:", f"{Process_Temperature:.2f}")

Roational_Temperature = st.number_input('Roational_Temperature', min_value=2.0, max_value=3000.0, value=3.0, step=5.0, format="%.2f") 
st.write("Roational_Temperature:", f"{Roational_Temperature:.2f}")

Torque_Temperature = st.number_input('Torque_Temperature', min_value=2.0, max_value=100.0, value=10.0, step=5.0, format="%.2f") 
